    ...
    <body>
        ...
        <div id="dashboard-container">
            <div id="dashboard-logo">
                <img src="https://pngimg.com/uploads/netflix/netflix_PNG4.png"/>
            </div>
               ...
               <div id="dashboard-nav-upload">
                ...
                <div id="dashboard-nav-menu">
                    ...
                    <ul class="bottom-nav-items">
                        <li class="nav-bottom-option"><a><i class="fa-solid fa-gear"></i> Settings</a></li>
                        <li class="nav-bottom-option"><a href="PHP\Scripts\userAccountLogout.php"><i class="fa-solid fa-arrow-right-from-bracket"></i> Sign Out</a></li>
                    </ul>
                </div>
            </div>
