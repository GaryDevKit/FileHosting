    ...
    <body onload="ShowFiles()">
        ...
        <div id="dashboard-container">
            ...
            <div id="dashboard-header">
                ...
                <div style="display: flex; align-items:center;"><a id="sm-media-button" onclick="showUploadArea()"><i class="fa-solid fa-circle-plus"></i></a></div>    
                <div style="display: flex; align-items:center;"><a id="notification-button" href=""><i class="fa-solid fa-bell"></i></a></div>
